...
When the palette earns its place, hand off to `$asterframe polish` for the final pass.
...
Layer 1-2 variant-specific params on top: palette selection (`steps` with named options), temperature warmth, or tint vs. true color. See `references/live.md` for the full params contract.
