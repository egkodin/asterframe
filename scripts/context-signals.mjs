#!/usr/bin/env node
/**
 * Context-signals gatherer for the bare `{{command_prefix}}asterframe`
 ...
 * light: no LLM calls, no detector run (`npx asterframe detect` is heavier and
 ...
 *   - critique:  the latest cached critique score (.asterframe/critique)
 ...
 * A URL means external Obscura inspection, and a probed dev-server port
