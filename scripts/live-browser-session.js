/**
 * Browser-side durable session helpers for Asterframe live mode.
 *
 ...
 * window.__ASTERFRAME_LIVE_SESSION__.
 */
(function (root) {
  'use strict';
  ...
  root.__ASTERFRAME_LIVE_SESSION__ = { createLiveBrowserSessionState };
