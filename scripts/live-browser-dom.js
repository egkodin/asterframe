/**
 * Browser-side DOM helpers for Asterframe live mode.
 *
...
(function (root) {
  ...
  function createLiveBrowserDomHelpers({
    ...
    function liveUiRoot() {
      const uiRoot = root.__ASTERFRAME_LIVE_UI_ROOT__;
